...
$('#examForm').submit(function(e){
		...
		if(aadhar.length == 0){
			...
			e.preventDefault();
			  ...
			  $("#aadhar").after('<span class="text-danger ">Aadhar Number should be of 12 digits</span>');
			  $("#aadhar").focus();
			  e.preventDefault();
			  return false;
		  }else if(aadhar.length > 12){
			  $("#aadhar").after('<span class="text-danger ">Aadhar Number should not be more than 12 digits</span>');
			  $("#aadhar").focus();
			  e.preventDefault();
			  return false;
		  }
